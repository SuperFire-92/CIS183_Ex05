...
public class MainActivity extends AppCompatActivity
{
    ...
    //Called from the else statement in getUserPermissions()
    ...
    public void getLocationEventListener()
    {
    ...
    public void gpsWiFiEventListener()
    {
        sw_j_gpsWiFi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    //Request a location with a balance between accuracy and power usage
                    locationRequest.setPriority(LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY);
                }
            }
        });
